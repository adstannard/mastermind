...
struct AttemptView: View {
    ...
    var body: some View {
        ...
        HStack{
            Text(String(attempt+1)).font(.system(size: 20, weight:.semibold, design:.default)).foregroundColor(currentAttempt == attempt ? Color(red: 0.0, green: 0.8, blue: 0.8) : currentAttempt > attempt ? Color(red: 0.0, green: 0.5, blue: 0.5) : Color.gray).frame(alignment: .topLeading)
